...
##permutation tests
if(x3==''){
	x1.pv<-anova(z1,model=model,...)[1,4]
	x2.pv<-anova(z2,model=model,...)[1,4]
	v1.pv<-anova(z1.2,model=model,...)[1,4]
	v2.pv<-anova(z2.1,model=model,...)[1,4]
	}
else{
	x1.pv<-anova(z1,model=model,...)[1,4]
	x2.pv<-anova(z2,model=model,...)[1,4]
	x3.pv<-anova(z3,model=model,...)[1,4]
	x12.pv<-anova(z12,model=model,...)[1,4]
	x13.pv<-anova(z13,model=model,...)[1,4]
	x23.pv<-anova(z23,model=model,...)[1,4]
	v1.pv<-anova(z1.23,model=model,...)[1,4]
	v2.pv<-anova(z2.13,model=model,...)[1,4]
	v3.pv<-anova(z3.12,model=model,...)[1,4]
	}
